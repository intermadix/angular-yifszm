...
export class AccountApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public createCompany(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
   ...
   * </em>
   */
  public updateCompany(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/accounts/:id/company";
    let _routeParams: any = {
   ...
   * This method returns no data.
   */
  public destroyCompany(id: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/accounts/:id/company";
    let _routeParams: any = {
  ...
  /**
   * Find a related item by id for unsortedcalls.
   *
   * @param {any} id account id
   *
   * @param {any} fk Foreign key for unsortedcalls
   *
   * @returns {object} An empty reference that will be
   *   populated with the actual data once the response is returned
   *   from the server.
   ...
   * </em>
   */
  public findByIdUnsortedcalls(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/accounts/:id/unsortedcalls/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  /**
   * Delete a related item by id for unsortedcalls.
   *
   * @param {any} id account id
   *
   * @param {any} fk Foreign key for unsortedcalls
   ...
   * This method returns no data.
   */
  public destroyByIdUnsortedcalls(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/accounts/:id/unsortedcalls/:fk";
    let _routeParams: any = {
  ...
  /**
   * Update a related item by id for unsortedcalls.
   *
   * @param {any} id account id
   *
   * @param {any} fk Foreign key for unsortedcalls
   ...
   * </em>
   */
  public updateByIdUnsortedcalls(id: any, fk: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/accounts/:id/unsortedcalls/:fk";
    let _routeParams: any = {
  ...
  /**
   * Fetches hasOne relation emailhandler.
   *
   * @param {any} id account id
   *
   * @param {boolean} refresh 
   ...
   * </em>
   */
  public getEmailhandler(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/accounts/:id/emailhandler";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Creates a new instance in emailhandler of this model.
   *
   * @param {any} id account id
   *
   * @param {object} data Request data.
   ...
   * </em>
   */
  public createEmailhandler(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/accounts/:id/emailhandler";
    let _routeParams: any = {
  ...
  /**
   * Update emailhandler of this model.
   *
   * @param {any} id account id
   *
   * @param {object} data Request data.
   ...
   * </em>
   */
  public updateEmailhandler(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/accounts/:id/emailhandler";
    let _routeParams: any = {
  ...
  /**
   * Deletes emailhandler of this model.
   *
   * @param {any} id account id
   *
   * @returns {object} An empty reference that will be
   ...
   * This method returns no data.
   */
  public destroyEmailhandler(id: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/accounts/:id/emailhandler";
    let _routeParams: any = {
  ...
  /**
   * Queries unsortedcalls of account.
   *
   * @param {any} id account id
   *
   * @param {object} filter 
   ...
   * </em>
   */
  public getUnsortedcalls(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/accounts/:id/unsortedcalls";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Creates a new instance in unsortedcalls of this model.
   *
   * @param {any} id account id
   *
   * @param {object} data Request data.
   ...
   * </em>
   */
  public createUnsortedcalls(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/accounts/:id/unsortedcalls";
    let _routeParams: any = {
  ...
  /**
   * Deletes all unsortedcalls of this model.
   *
   * @param {any} id account id
   *
   * @returns {object} An empty reference that will be
   ...
   * This method returns no data.
   */
  public deleteUnsortedcalls(id: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/accounts/:id/unsortedcalls";
    let _routeParams: any = {
  ...
  /**
   * Counts unsortedcalls of account.
   *
   * @param {any} id account id
   *
   * @param {object} where Criteria to match model instances
   ...
   *  - `count` – `{number}` - 
   */
  public countUnsortedcalls(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/accounts/:id/unsortedcalls/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public addStdRelation(id: any = {}, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/accounts/addstdrelation/:id";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public createManyCompany(id: any, data: any[] = [], customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/accounts/:id/company";
    let _routeParams: any = {
   ...
   * </em>
   */
  public createManyEmailhandler(id: any, data: any[] = [], customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/accounts/:id/emailhandler";
    let _routeParams: any = {
   ...
   * </em>
   */
  public createManyUnsortedcalls(id: any, data: any[] = [], customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/accounts/:id/unsortedcalls";
    let _routeParams: any = {
