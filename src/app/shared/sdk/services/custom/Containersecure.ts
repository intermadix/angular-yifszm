...
/**
 * Api services for the `Containersecure` model.
 */
@Injectable()
export class ContainersecureApi extends BaseLoopBackApi {
  ...
  public getFiles(container: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/containersecures/:container/files";
    let _routeParams: any = {
      container: container
    };
    let _postBody: any = {};
  ...
  public getFile(container: any, file: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/containersecures/:container/files/:file";
    let _routeParams: any = {
      container: container,
      file: file
    };
  ...
  public upload(container: any, req: any = {}, res: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/containersecures/:container/upload";
    let _routeParams: any = {
      container: container
    };
    let _postBody: any = {};
  ...
  public download(container: any, file: any, req: any = {}, res: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/containersecures/:container/download/:file";
    let _routeParams: any = {
      container: container,
      file: file
    };
  ...
  public getFilesByFilename(companyId: any = {}, itemName: any = {}, customHeaders?: Function): Observable<any> {
    ...
    if (typeof itemName !== 'undefined' && itemName !== null) _urlParams.itemName = itemName;
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
    return result;
  }
